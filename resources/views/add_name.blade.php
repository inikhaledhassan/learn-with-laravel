...
<body>
    <form action="/addname/store" method="POST">
        @csrf
        ...
        @endif
        <a href="/view" style="display: inline-block; padding: 10px 20px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 5px;">View</a>
    </form>
</body>
</html>